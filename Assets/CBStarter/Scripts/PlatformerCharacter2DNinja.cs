...
{
    public class PlatformerCharacter2DNinja : MonoBehaviour
    {
        ...
        private void Flip()
        {
            ...
            // rotate fireball spawn when player rotates
            Vector3 rot = fireballSpawn.rotation.eulerAngles;
            rot = new Vector3(rot.x, rot.y + 180, rot.z);
            fireballSpawn.rotation = Quaternion.Euler(rot);
        }
        ...
        {
            isAttacking = false;
            m_Anim.ResetTrigger("Attack1");
            m_Anim.ResetTrigger("Attack2");
